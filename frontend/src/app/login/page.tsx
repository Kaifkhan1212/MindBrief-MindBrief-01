            ...
            <Card className="w-full max-w-md shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
                ...
                <CardContent className="space-y-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                required
                                className="h-12 bg-slate-50 border-slate-200 focus:bg-white focus:border-indigo-500 focus:ring-indigo-500/20"
                            />
                        </div>
                        <div className="space-y-2">
                    ...
                    <Button
                        ...
                        disabled={isLoading}
                        className="w-full h-12 bg-white border-slate-200 text-slate-700 hover:bg-slate-50 font-medium"
                    >
